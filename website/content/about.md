...
url: "/about/"
layout: "video-header"
video: "video/about-bg.mp4"
mobile_image: "img/mobile-golden-gate.jpg"
---

## What is SFMIX?

The San Francisco Metropolitan Internet eXchange (SFMIX) is an [Internet Exchange](https://en.wikipedia.org/wiki/Internet_exchange_point) (IX) in the San Francisco Bay Area.
...
**[Real people](/team/)** — Your critical traffic traverses local networks operated by local people with real email addresses and phone numbers. When you peer with your neighbors, your viewpoint is heard.
...
The more networks that connect, the more valuable the exchange becomes — a cooperative example of [Metcalfe's Law](http://en.wikipedia.org/wiki/Metcalfe%27s_law).

## Where to Connect?

SFMIX operates across multiple carrier-neutral [locations](/locations/) in San Francisco, Santa Clara, Fremont, and San Jose. Additional sites are planned based on demand.
...
Today SFMIX spans 9 locations with 1, 10, 100, and 400Gbps port speeds. SFMIX is an IRS 501(c)(12) cooperative — part of a community of member-owned exchanges including [SIX](http://www.seattleix.net/), [NWAX](http://www.nwax.net/), and [MICE](http://www.micemn.net/).

Meet the [people behind SFMIX](/team/).
