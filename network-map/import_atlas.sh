#!/usr/bin/env bash
# ============================================================================
# DEPRECATED (2026-07-06) — superseded by the NetBox-hint-driven KMZ miner.
# The atlas is now regenerated by:
#     scripts/map_kmz_mine.py --kmz-dir <KMZ dir>   # -> atlas_precise/ (NDA, gitignored)
#     scripts/map_coarsen.py                         # -> network-map/atlas/ (committed)
# which derives per-circuit routes from NetBox endpoints (no hand-tuned placemark/
# match/stitch args) and graph-stitches off-ring chains. Kept only for reference /
# the KMZ-file provenance below. Do not run to regenerate the atlas.
# ============================================================================
