# SFMIX
This is an SFMIX-internal vendored fork of git@github.com:DavidWittman/ansible-redis.git
...
- [ansible-redis](#ansible-redis)
  ...
  - [Getting started](#getting-started)
    ...
    - [Multiple role inclusions](#multiple-role-inclusions)
  - [Advanced Options](#advanced-options)
    - [Verifying checksums](#verifying-checksums)
    - [Install from local tarball](#install-from-local-tarball)
    - [Building 32 bit binaries](#building-32-bit-binaries)
    - [Building with TLS support](#building-with-tls-support)
